...
1. clonar repo:
<a href="https://github.com/jcvaldes/delilahresto.git">git clone https://github.com/jcvaldes/delilahresto.git</a>
...
7. El deploy se encuentra deployado en heroku en la siguiente url https://delilahresto.herokuapp.com/
